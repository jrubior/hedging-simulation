%% run_hedging.m
%  Estimate SV-X (Student-t) model for Hedging portfolio returns.
%
...
%% ---- Settings ----
NParticles      = 2000;     % Number of particles in the filter
...
% Draw standardized innovations: eps ~ t_nu scaled to Var(eps)=1
eps_sim = trnd(p.nu, Tsim, Nsim) * sqrt((p.nu - 2) / p.nu);
...
fprintf('\n======== MOMENT COMPARISON: SIMULATED vs TARGET (Hedging) ========\n');
