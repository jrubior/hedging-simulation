%% run_hedging_jump.m
%  Estimate SV-X (Normal + Exponential Jumps) model for Hedging portfolio returns.
%
%  Model:
...
% Draw jump components: J_t ~ Bernoulli(p_j), Z_t ~ Exp(mu_j)
J_sim = (rand(Tsim, Nsim) < p.p_j);
...
fprintf('\n=== MOMENT COMPARISON: SIMULATED vs TARGET (Hedging, Jump) ===\n');
